...
| Name | Role |
|------|------|
| Madhan Mohan Naidu .M (22BCY10182) | Core implementation, Wazuh server setup, Active Response, TheHive integration |
| Rehan Rajesh (22BCY10196) | Ubuntu server setup, network configuration, infrastructure support |
| V.A.Aaswin (22BCY10257) | Documentation and report compilation |
| Insaf Sadik A S (22BCY10282) | Attack simulation, testing, and validation |
 
**Supervisor:** Dr. Hariharasitaraman S  
**Program Chair:** Dr. Saravanan D  
